    ...
    <div class="px-6 md:px-10 pt-10 ">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            ...
            <div class="flex gap-2">
                <div>
                    <input type="text" placeholder="Cari Pegawai" v-model="search" @keyup="searchUser"
                ...
                <ButtonBiru text="Tambah Pegawai" @click="openModal" />
            </div>
...
import ModalUser from './ModalEmployees.vue';
